...
public class safeFileReader {
	...
	public static void main(String[] args) throws ConnectorException, URISyntaxException, IOException {
		...
		String filename = "traces/outputStreamSafeTrace.txt";
		...
		Function check_annoInput = new CheckAnnotation(new Scanner(SafeEnum.class.getResourceAsStream("MethodsSignatures/ontputStreamSignatures.txt")));
		Function check_annowrite = new CheckAnnotation(new Scanner(SafeEnum.class.getResourceAsStream("MethodsSignatures/read-signatures.txt")));
