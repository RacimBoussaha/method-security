 ...
 */
public class GetEventType2 extends UnaryFunction<MethodEvent2,String>
{
	/**
	 * A single instance of this function
	 */
	public static final GetEventType2 instance = new GetEventType2();
	
	private GetEventType2() 
	{
		super(MethodEvent2.class, String.class);
	}

	@Override
	public String getValue(MethodEvent2 x)
	{
