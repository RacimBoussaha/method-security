...
public abstract class MethodEvent2 
{
	...
	public MethodEvent2(String name)
	{
		super();
		m_methodName = name;
	...
	public static class MethodCall2 extends MethodEvent2
	{
		...
		public MethodCall2(String name,String returnType,MethodReturn returnValue,String level,String object, String[] types ,Object [] parameters)
		{
			super(name);
			m_level=level;
	...
	public static class MethodKey2 extends MethodCall2
	{
		...
		public MethodKey2(String name,String returnType,MethodReturn returnValue,String level,String object,int Kindex,String[] types , Object [] parameters)
		{
			
			super(name,returnType,returnValue,level,object,types,parameters);
			KeyIndex=Kindex;
